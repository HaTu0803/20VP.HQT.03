...
export default {
    ...
    async GiaMonAn() {
        const sql = `exec EX_1_READ_INFO_UNCOMMITTED_READ_FIX`
        try {
            const list = await db.raw(sql)
            return list
        } catch (error) {
    ...
    async TenMonAn() {
        ...
        const sql = `exec EX_5_READ_MENU_UNREPEATABLE_READ_FIX`
        try {
            const list = await db.raw(sql)
            return list
        } catch (error) {
    ...
    async getTranhChap9() {
        const sql = `exec EX_9_READ_MONAN_PHANTOM_FIX`
        try {
            const list = await db.raw(sql);
            return list
        } catch (error) {
    ...
    async setTranhChap6() {
        const sql = `exec EX_6_READ_MONAN_UNREPEATABLE_READ_FIX`
        try {
            const list = await db.raw(sql);
            return list
        } catch (error) {
